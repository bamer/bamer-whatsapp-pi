...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		async execute(_toolCallId) {
			const sayings = [
				// Proverbes français traditionnels
				...
				"Qui vivra verra. 👁️",
				"Avoir beau jeu. 🃏",
				"Chacun voit midi à sa porte. ☀️",
				"Il n'y a que les vues qui coûtent. 👀",
				"Tout vient en son temps. ⏳",
				"Belle n'est que ce qui plaît. 🌹",
				"C'est au besoin qu'on connaît ses amis. 🤝",
				"Dis-moi qui tu hantes, je te dirai qui tu es. 🏠",
				"L'habit ne fait pas le moine. 🧥",
				"Mieux vaut tard que jamais. ⏰",
				"Les absents ont toujours tort. 🚪",
				"Qui se ressemble s'assemble. 🧲",
				"Il faut manger pour vivre et non vivre pour manger. 🍽️",
				"Argent n'est pas bourse. 💰",
				"Chassez le naturel, il revient au galop. 🐎",
				"C'est le métier qui rentre. 🛠️",
				"Dieu aide les grandes pensées. 🙏",
				"La raison du plus fort est toujours la meilleure. ⚖️",
				"Tout est bien qui finit bien. 🎭",
				"Il faut que la montagne accouche. 🏔️",
				"Avoir le cerveau comme un entonnoir. 🧠",
				"Chaque chose a son prix. 💎",
				"La peur fait souvent plus de loups que n'en montre la forêt. 🐺",
				"Qui a du pain n'a pas de souliers. 🥖",
				"Il n'y a que les montagnes qui ne se rencontrent jamais. 🏔️",
				"L'argent ne fait pas le bonheur. 💵",
				"Petit poisson deviendra grand. 🐟",
				"Qui ne risque rien n'a rien. 🎲",
				"Tout est dans tout. 🌍",
				"Avoir l'esprit large comme la rue de Rivoli. 🛣️",
				"Chacun son goût. 🎨",
				"Deux, trois, dix ! 🎯",
				"La route est longue, le chemin est droit. 🛤️",
				...
				"Chacun porte le poids de ses actes. ⚖️",
				"Deux marteaux valent mieux qu'un. 🔨",
				"Avoir les yeux plus gros que le ventre. 👁️🍽️",
				"La nuit porte conseil. 🌙",
				"Chaque oiseau est beau pour sa mère. 🐦",
				"Avoir la main verte. 🌿",
				"C'est la fin des haricots. 🫘",
				"Qui a les oreilles écoute. 👂",
				"Avoir un fil de la tête. 🧵",
				"Chaque chose en son temps. ⏰",
				"Il n'y a que le premier pas qui coûte. 👣",
				"Avoir du fiel. 🐍",
				"C'est la vie ! 🌍",
				"Qui se dit poisson nage. 🐟",
				"Avoir les mains dans le cambouis. 🔧",
				"Chaque histoire a son histoire. 📖",
				"Avoir du culot. 🎭",
				"C'est trop beau pour être vrai. ✨",
				"Avoir la tête en l'air. ☁️",
				"Chaque jour mérite d'être vécu. 🌅",
				"Avoir les pieds sur terre. 👣",
				"C'est l'hôpital qui se moque de la charité. 🏥",
				"Avoir le cœur sur la main. ❤️",
				"Chaque chemin mène à Rome. 🏛️",
				"Avoir la main lourde. 🖐️",
				"C'est à connaître ! 📋",
